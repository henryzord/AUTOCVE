...
class PythonInterface{
    ...
    public: PythonInterface(int n_jobs, PyObject* timeout_pip_sec, PyObject *scoring, int cv_folds, int verbose);
    ~PythonInterface();
    int load_dataset(PyObject *data_X, PyObject *data_y, double subsample_data);
    int unload_dataset();
